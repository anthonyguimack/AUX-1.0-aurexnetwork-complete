  ...
  return (
    <div data-testid="news-detail-page">
      <div className="relative h-[350px] md:h-[400px] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center max-w-3xl px-6">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-white mt-3" style={{ fontFamily: 'Playfair Display, serif' }} data-testid="news-detail-title">{post.title}</h1>
          </div>
        </div>
      </div>
      <div className="max-w-4xl mx-auto px-6 md:px-12 py-12 pt-24 md:pt-28">
        ...
        <div className="rich-text-content" dangerouslySetInnerHTML={{ __html: post.content }} data-testid="news-detail-content" />
