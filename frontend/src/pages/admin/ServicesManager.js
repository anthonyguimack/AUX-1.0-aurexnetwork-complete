...
const emptyService = { title: '', description: '', icon: 'briefcase', price: 0, currency: 'usd', type: 'service' };
        ...
        <DialogContent className="sm:max-w-[500px]" data-testid="service-dialog">
          ...
          {editing && (
            <div className="space-y-4">
              ...
              <div><Label>Description</Label><textarea value={editing.description} onChange={e => setEditing({...editing, description: e.target.value})} rows={3} className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-sm text-sm mt-1" data-testid="service-desc-input" /></div>
