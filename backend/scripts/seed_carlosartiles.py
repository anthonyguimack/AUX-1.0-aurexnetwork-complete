...
async def seed():
    ...
    await db.aurex_section_items.insert_many([
        {"section": "aurex_pricing", "id": uid(),
         ...
         "currency":{"en": "one-time",  "es": "pago único"},
         ...
         "features": {"en": "Brand Discovery Session (2hr) · LinkedIn Profile Audit & Rewrite · 3 Core Messaging Pillars · 30-Day Content Plan · Email Support for 30 Days",
                      "es": "Sesión de Descubrimiento de Marca (2h) · Auditoría y Reescritura de LinkedIn · 3 Pilares de Mensajes · Plan de Contenido 30 Días · Soporte por Email 30 Días"},
         "featured": False, "cta_text": {"en": "Get Started", "es": "Comenzar"}, "order": 0},
        {"section": "aurex_pricing", "id": uid(),
         ...
         "features": {"en": "Everything in Starter · 12 Weekly 1:1 Calls · Full Brand Kit · LinkedIn Makeover · 90-Day Content Calendar · Media Pitch Templates · 3 Months WhatsApp Support",
                      "es": "Todo en Inicial · 12 Llamadas Semanales 1:1 · Kit de Marca Completo · Renovación de LinkedIn · Calendario de Contenido 90 Días · Plantillas para Medios · 3 Meses Soporte WhatsApp"},
         "featured": True, "badge": {"en": "Most Popular", "es": "Más Popular"},
         "cta_text": {"en": "Apply Now", "es": "Aplicar Ahora"}, "order": 1},
        {"section": "aurex_pricing", "id": uid(),
         ...
         "features": {"en": "Everything in Accelerator · 6 Months Weekly Calls · Executive Presence Coaching · Media Training · Speaking Bureau Introduction · Personal PR Support · Priority Access to New Programmes",
                      "es": "Todo en Acelerador · 6 Meses de Llamadas Semanales · Coaching de Presencia Ejecutiva · Entrenamiento en Medios · Introducción a Bureau de Oradores · Soporte PR Personal · Acceso Prioritario a Nuevos Programas"},
         "featured": False, "cta_text": {"en": "Inquire Now", "es": "Consultar Ahora"}, "order": 2},
    ])
    ...
    await db.nav_pages.insert_many([
        {"title": {"en": "Home",         "es": "Inicio"},       "url": "/",           "show_in_nav": True,  "show_in_footer": False, "order": 0},
        {"title": {"en": "About",        "es": "Sobre Mí"},     "url": "/#about",     "show_in_nav": True,  "show_in_footer": True,  "order": 1},
        {"title": {"en": "Services",     "es": "Servicios"},    "url": "/#services",  "show_in_nav": True,  "show_in_footer": True,  "order": 2},
        {"title": {"en": "Case Studies", "es": "Casos de Éxito"}, "url": "/#portfolio", "show_in_nav": True, "show_in_footer": True,  "order": 3},
        {"title": {"en": "Blog",         "es": "Blog"},         "url": "/#blog",      "show_in_nav": True,  "show_in_footer": True,  "order": 4},
        {"title": {"en": "Contact",      "es": "Contacto"},     "url": "/#contact",   "show_in_nav": True,  "show_in_footer": True,  "order": 5},
        {"title": {"en": "Member Portal", "es": "Portal de Miembros"}, "url": "/my-account", "show_in_nav": False, "show_in_footer": True, "order": 6},
    ])
    print("✓ nav_pages (7)")
